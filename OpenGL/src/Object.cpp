...
Object::Object(GLFWwindow* window, unsigned int programID, const char* filename, const char* texture_name)
{
	m_filename = filename;
	...
	m_camera->LookAt(vec3(10), vec3(0), vec3(0, 1, 0));
...
void Object::Update(float deltaTime)
{
	...
	m_lightYPos = glm::vec3(sinf((float)glfwGetTime()) * 100, 100.0f,  cosf((float)glfwGetTime()) * 100);
}
